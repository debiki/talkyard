      ...
      embeddedComments: {
        ...
        options: {
          ...
          footer: """
            ...
            // After minifying it, I had to change two '\' to '\\'.
            ...
            // Load jQuery and Modernizr unless already done. Then run Debiki's code.

            function loadModernizrThenRunDebiki() {
              if (!window.Modernizr) {
            ...
            loadJQueryThenModernizrThenRunDebiki();
