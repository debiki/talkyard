...
trait MessagesDao {
  ...
  def startGroupTalk(title: TitleSourceAndHtml, body: TextAndHtml, pageRole: PageType,
    ...
    // to the other group managers. Then, if you couldn't message oneself (as one of
    // the others), you might need to list the other group managers, but exclude oneself
    //  — Then the others can guess who you are.
