...
describe(`move-posts-newer-page.d.2br TyTMOPONEPG`, () => {
  ...
  it(`Construct site`, async () => {
    ...
    const destPage: PageJustAdded = builder.addPage({
      id: 'destPage',
      folder: '/',
      showId: false,
      slug: 'dest-page',
  ...
  it(`Owen can pin the page (runs some [pin_comt_count_checks])`, async () => {
  ...
  it(`Owen can pin the page (runs some [pin_comt_count_checks] — and once there was
          ...
          reply got moved elsewhere)`, async () => {
