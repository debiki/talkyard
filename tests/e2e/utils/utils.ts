...
const utils = {
  ...
  makeEmbeddedCommentsHtml(ps: { pageName: string, discussionId: string,
      localHostname: string, bgColor: string }): string {
...
<body style="background: ${ps.bgColor}; color: #ccc; font-family: monospace">
<p>Embedded comments E2E test page ${ps.pageName}, discussion-id="${ps.discussionId}"${ieEmpty}.<br>
