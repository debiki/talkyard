/* Old! Updates the page with new data from server, e.g. if comment was edited.
...
// Should be removed, when possible. Use debiki-patch-page.ls instead!
// It's still in use though; grep for mergeChangesIntoPage.
// And it's buggy!
