...
class SpecialContentController {
  ...
  constructor(private $scope: SpecialContentScope, private queryService: QueryService) {
  }

}


debiki2.admin.adminApp.controller('SpecialContentController', SpecialContentController);
