...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "com.typesafe.akka" % "akka-protobuf-v3_2.12" % "2.6.19",
      "com.typesafe.akka" % "akka-serialization-jackson_2.12" % "2.6.19",
      "com.typesafe.akka" % "akka-slf4j_2.12" % "2.6.19",
      "com.typesafe.akka" % "akka-stream_2.12" % "2.6.19",
      "com.typesafe.play" % "build-link" % "2.8.15",
      "com.typesafe.play" % "cachecontrol_2.12" % "2.0.0",
      "com.typesafe.play" % "filters-helpers_2.12" % "2.8.15",
      "com.typesafe.play" % "play-ahc-ws-standalone_2.12" % "2.1.7",
      "com.typesafe.play" % "play-ahc-ws_2.12" % "2.8.15",
      "com.typesafe.play" % "play-akka-http-server_2.12" % "2.8.15",
      "com.typesafe.play" % "play-cache_2.12" % "2.8.15",
      "com.typesafe.play" % "play-caffeine-cache_2.12" % "2.8.15",
      "com.typesafe.play" % "play-exceptions" % "2.8.15",
      "com.typesafe.play" % "play-functional_2.12" % "2.9.2",
      "com.typesafe.play" % "play-json_2.12" % "2.9.2",
      "com.typesafe.play" % "play-logback_2.12" % "2.8.15",
      "com.typesafe.play" % "play-server_2.12" % "2.8.15",
      "com.typesafe.play" % "play-streams_2.12" % "2.8.15",
      ...
      "com.typesafe.play" % "play-ws_2.12" % "2.8.15",
      "com.typesafe.play" % "play_2.12" % "2.8.15",
      ...
      "org.elasticsearch" % "elasticsearch" % "8.2.1",
