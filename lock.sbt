...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "com.typesafe.play" % "filters-helpers_2.12" % "2.8.16",
      "com.typesafe.play" % "play-ahc-ws-standalone_2.12" % "2.1.10",
      "com.typesafe.play" % "play-ahc-ws_2.12" % "2.8.16",
      "com.typesafe.play" % "play-akka-http-server_2.12" % "2.8.16",
      ...
      "com.typesafe.play" % "play-ws_2.12" % "2.8.16",
      ...
      "org.elasticsearch.client" % "transport" % "7.17.6",
