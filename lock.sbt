...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "com.fasterxml.jackson.module" % "jackson-module-scala_2.13" % "2.19.0",
      ...
      "com.typesafe.play" % "play-ahc-ws-standalone_2.13" % "2.2.12",
      "com.typesafe.play" % "play-ahc-ws_2.13" % "2.9.9",
      "com.typesafe.play" % "play-akka-http-server_2.13" % "2.9.9",
      "com.typesafe.play" % "play-build-link" % "2.9.9",
      "com.typesafe.play" % "play-cache_2.13" % "2.9.9",
      "com.typesafe.play" % "play-caffeine-cache_2.13" % "2.9.9",
      "com.typesafe.play" % "play-configuration_2.13" % "2.9.9",
      "com.typesafe.play" % "play-exceptions" % "2.9.9",
      "com.typesafe.play" % "play-filters-helpers_2.13" % "2.9.9",
      "com.typesafe.play" % "play-functional_2.13" % "2.10.7",
      "com.typesafe.play" % "play-json_2.13" % "2.10.7",
      "com.typesafe.play" % "play-server_2.13" % "2.9.9",
      "com.typesafe.play" % "play-streams_2.13" % "2.9.9",
      "com.typesafe.play" % "play-ws-standalone-json_2.13" % "2.2.12",
      "com.typesafe.play" % "play-ws-standalone-xml_2.13" % "2.2.12",
      "com.typesafe.play" % "play-ws-standalone_2.13" % "2.2.12",
      "com.typesafe.play" % "play-ws_2.13" % "2.9.9",
      "com.typesafe.play" % "play_2.13" % "2.9.9",
      "com.typesafe.play" % "shaded-asynchttpclient" % "2.2.12",
      "com.typesafe.play" % "shaded-oauth" % "2.2.12",
      ...
      "org.elasticsearch" % "elasticsearch" % "9.1.4",
...
// LIBRARY_DEPENDENCIES_HASH 8011bf21d2ee13c3cc8bd39cf476a5af5ebda2a1
