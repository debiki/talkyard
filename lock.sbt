...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "com.typesafe.play" % "play-ahc-ws_2.13" % "2.9.8",
      "com.typesafe.play" % "play-akka-http-server_2.13" % "2.9.8",
      "com.typesafe.play" % "play-build-link" % "2.9.8",
      "com.typesafe.play" % "play-cache_2.13" % "2.9.8",
      "com.typesafe.play" % "play-caffeine-cache_2.13" % "2.9.8",
      "com.typesafe.play" % "play-configuration_2.13" % "2.9.8",
      "com.typesafe.play" % "play-exceptions" % "2.9.8",
      "com.typesafe.play" % "play-filters-helpers_2.13" % "2.9.8",
      "com.typesafe.play" % "play-functional_2.13" % "2.10.7",
      "com.typesafe.play" % "play-json_2.13" % "2.10.7",
      "com.typesafe.play" % "play-server_2.13" % "2.9.8",
      "com.typesafe.play" % "play-streams_2.13" % "2.9.8",
      ...
      "com.typesafe.play" % "play-ws_2.13" % "2.9.8",
      ...
      "org.elasticsearch" % "elasticsearch" % "9.1.1",
