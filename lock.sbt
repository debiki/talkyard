...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "org.elasticsearch" % "elasticsearch-ssl-config" % "6.8.20",
      "org.elasticsearch" % "elasticsearch-x-content" % "6.8.20",
      ...
      "org.elasticsearch.plugin" % "percolator-client" % "6.8.20",
      "org.elasticsearch.plugin" % "rank-eval-client" % "6.8.20",
      "org.elasticsearch.plugin" % "reindex-client" % "6.8.20",
      "org.elasticsearch.plugin" % "transport-netty4-client" % "6.8.20",
...
// LIBRARY_DEPENDENCIES_HASH ec951c0678a58d6dd04d7579e04b8643a9aff3ad
