...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "com.typesafe.play" % "filters-helpers_2.12" % "2.8.22",
      "com.typesafe.play" % "play-ahc-ws-standalone_2.12" % "2.1.11",
      "com.typesafe.play" % "play-ahc-ws_2.12" % "2.8.22",
      "com.typesafe.play" % "play-akka-http-server_2.12" % "2.8.22",
      "com.typesafe.play" % "play-cache_2.12" % "2.8.20",
      "com.typesafe.play" % "play-caffeine-cache_2.12" % "2.8.22",
      ...
      "com.typesafe.play" % "play-server_2.12" % "2.8.22",
