...
Compile / dependencyOverrides ++= {
  if (!(ThisBuild / sbtLockHashIsUpToDate).value && sbtLockIgnoreOverridesOnStaleHash.value) {
    ...
    Seq(
      ...
      "com.fasterxml.jackson.module" % "jackson-module-scala_2.12" % "2.18.1",
      ...
      "com.typesafe.play" % "build-link" % "2.8.21",
      ...
      "com.typesafe.play" % "play-ahc-ws_2.12" % "2.8.21",
      "com.typesafe.play" % "play-akka-http-server_2.12" % "2.8.21",
      "com.typesafe.play" % "play-cache_2.12" % "2.8.21",
      "com.typesafe.play" % "play-caffeine-cache_2.12" % "2.8.21",
      "com.typesafe.play" % "play-exceptions" % "2.8.21",
      "com.typesafe.play" % "play-functional_2.12" % "2.9.4",
      "com.typesafe.play" % "play-json_2.12" % "2.9.4",
      "com.typesafe.play" % "play-server_2.12" % "2.8.21",
      "com.typesafe.play" % "play-streams_2.12" % "2.8.21",
      ...
      "com.typesafe.play" % "play-ws_2.12" % "2.8.21",
      "com.typesafe.play" % "play_2.12" % "2.8.21",
...
// LIBRARY_DEPENDENCIES_HASH 53ea6d499dde8b4a6ffe0b135a03601117711ebc
