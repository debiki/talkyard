...
Vagrant.configure("2") do |config|
  ...
  # launched VM.
  config.vm.provision :shell, :path => "scripts/vagrant-bootstrap-ubuntu-server-12.04-amd64.sh"

  # The url from where the 'config.vm.box' box will be fetched if it
  # doesn't already exist on the user's system.
  # Find a list of boxes here: http://www.vagrantbox.es/
  # Boxes from puppetlabs.com can be trusted I presume.
