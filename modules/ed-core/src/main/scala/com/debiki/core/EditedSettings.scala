...
case class EditedSettings(
  ...
  singleSignOnEnabled: Option[Boolean],
  singleSignOnSecret: Option[String],
  singleSignOnLoginUrl: Option[String],
  singleSignOnLogoutUrl: Option[String],
  ...
  embeddedOnlyHideSite: Option[Boolean],
...
object EditedSettings {
  ...
  val empty = EditedSettings(
    ...
    singleSignOnEnabled = None,
    singleSignOnSecret = None,
    singleSignOnLoginUrl = None,
    singleSignOnLogoutUrl = None,
    forumMainView = None,
...
case class SettingsToSave(
  ...
  singleSignOnEnabled: Option[Option[Boolean]] = None,
  singleSignOnSecret: Option[Option[String]] = None,
  singleSignOnLoginUrl: Option[Option[String]] = None,
  singleSignOnLogoutUrl: Option[Option[String]] = None,
  ...
  embeddedOnlyHideSite: Option[Option[Boolean]] = None,
